...
DMLAB30_LEVELS = tuple([key for key in LEVEL_MAPPING.keys() if key not in CUSTOM_DMLAB_TASKS])
DMLAB30_LEVELS_TEST = tuple([key for key in LEVEL_MAPPING.keys() if key not in CUSTOM_DMLAB_TASKS])
