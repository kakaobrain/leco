...
def register_default_envs(env_registry):
    ...
    def minigrid_funcs():
        ...
        from sample_factory.envs.minigrid.minigrid_params import add_minigrid_env_args, minigrid_override_defaults
        return make_minigrid_env, add_minigrid_env_args, minigrid_override_defaults
