...
class ReinforcementLearningAlgorithm(AlgorithmBase, ABC):
    ...
    def add_cli_args(cls, parser):
        ...
        p.add_argument('--save_milestones_step', default=-1, type=int, help='Save intermediate checkpoints in a separate folder for later evaluation (default=never)')
        ...
        p.add_argument('--scheduler', default=None, type=str, help='LR scheduler')
        p.add_argument('--warmup', default=0, type=int, help='warm up')
        p.add_argument('--warmup_optimizer', default=0, type=float, help='warm up step for leaner, optimizer step count')

        p.add_argument('--train_for_env_steps', default=1e10, type=float, help='Stop after all policies are trained for this many env steps')
        ...
        p.add_argument('--encoder_pooling', default='max', choices=['stride', 'max', 'avg'], type=str, help='pooling method in CNN')
        p.add_argument('--no_pooling_last_cnn', default=False, type=str2bool, help='apply pooling for last cnn or not')
        ...
        p.add_argument('--policy_initialization', default='orthogonal', choices=['orthogonal', 'xavier_uniform', 'kaiming', 'transformer', 'impala'], type=str, help='NN weight initialization')
